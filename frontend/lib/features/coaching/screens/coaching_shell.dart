...
import '../../assessment/screens/coaching_assessment_screen.dart';
...
class _CoachingShellState extends State<CoachingShell> {
  ...
  bool get _isAdmin =>
      _coaching.ownerId == widget.user.id || _coaching.myRole == 'ADMIN';

  /// Screens list depends on role.
  /// Admin: Dashboard(0), Members(1), Batches(2), Profile(3)
  /// Non-admin: Dashboard(0), Assessment(1), Batches(2), Profile(3)
  int get _screenCount => 4;
  ...
  Widget _buildScreen(int index) {
    if (_isAdmin) {
      ...
      // Non-admin: Assessment replaces Members
      switch (index) {
        case 0:
          return CoachingDashboardScreen(
            coaching: _coaching,
        ...
        case 1:
          return CoachingAssessmentScreen(
            coaching: _coaching,
            user: widget.user,
          );
        case 2:
